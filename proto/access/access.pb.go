...
func (*Id) Descriptor() ([]byte, []int) {
	return fileDescriptor_d30f5b6e935be50b, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*Request)(nil), "libgo.rbac.access.Request")
...
var fileDescriptor_d30f5b6e935be50b = []byte{
	...
	,
}
...
type AccessServiceClient interface {
	...
	GetAllAccessPermission(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *accessServiceClient) GetAllAccessPermission(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/libgo.rbac.access.AccessService/GetAllAccessPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccessServiceServer interface {
	...
	GetAllAccessPermission(context.Context, *Request) (*Response, error)
...
func _AccessService_GetAllAccessPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessServiceServer).GetAllAccessPermission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/libgo.rbac.access.AccessService/GetAllAccessPermission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessServiceServer).GetAllAccessPermission(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccessService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllAccessPermission",
			Handler:    _AccessService_GetAllAccessPermission_Handler,
		},
		{
